...
class MultimediaPicker extends Field
{
    use CanBeOutlined;
    ...
    protected function setUp(): void
    {
        ...
        $this->afterStateHydrated(static function (MultimediaPicker $component, array | int | string | null $state): void {
        ...
        $this->afterStateUpdated(function (MultimediaPicker $component, array | int | null $state): void {
            if (! filled($state)) {
                $component->state([]);
            }
        ...
        $this->dehydrateStateUsing(function (MultimediaPicker $component, $state) {
            if (! filled($state)) {
                return null;
            }
        ...
        $this->registerActions([
            fn (MultimediaPicker $component): Action => $component->getDownloadAction(),
            fn (MultimediaPicker $component): Action => $component->getEditAction(),
            fn (MultimediaPicker $component): Action => $component->getRemoveAction(),
            fn (MultimediaPicker $component): Action => $component->getRemoveAllAction(),
            fn (MultimediaPicker $component): Action => $component->getReorderAction(),
            fn (MultimediaPicker $component): Action => $component->getViewAction(),
            fn (MultimediaPicker $component): Action => $component->getPickerAction(),
        ]);
    }
    ...
    public function getReorderAction(): Action
    {
        return Action::make('reorder')
            ...
            ->action(function (array $arguments, MultimediaPicker $component): void {
    ...
    public function getDownloadAction(): Action
    {
        return Action::make('download')
            ...
            ->color('gray')
            ->action(function (array $arguments, MultimediaPicker $component): StreamedResponse {
    ...
    public function getEditAction(): Action
    {
        return Action::make('edit')
            ...
            ->color('gray')
            ->hidden(fn (MultimediaPicker $component): bool => $component->isDisabled())
    ...
    public function getPickerAction(): Action
    {
        return Action::make('open_curator_picker')
            ...
            ->size($this->getSize())
            ->action(function (MultimediaPicker $component, \Livewire\Component $livewire) {
    ...
    public function getRemoveAllAction(): Action
    {
        return Action::make('removeAll')
            ...
            ->color('danger')
            ->size($this->getSize())
            ->action(function (MultimediaPicker $component): void {
                $component->state([]);
            });
    }
    ...
    public function getViewAction(): Action
    {
        return Action::make('view')
            ...
            ->icon('heroicon-s-eye')
            ->color('gray')
            ->action(function (array $arguments): string {
    ...
    public function relationship(string | Closure $relationshipName, string | Closure $titleColumnName, ?Closure $callback = null): static
    {
        ...
        $this->loadStateFromRelationshipsUsing(static function (MultimediaPicker $component, $state): void {
            if (filled($state)) {
                return;
            }
        ...
        $this->saveRelationshipsUsing(static function (MultimediaPicker $component, Model $record, $state) {
        ...
        $this->dehydrated(fn (MultimediaPicker $component): bool => ! $component->isMultiple());
